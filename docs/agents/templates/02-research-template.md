...
Be concrete: "Which Node.js stream backpressure strategy minimises memory usage for large file processing?" not "how do streams work".
...
How these findings apply given this repo's specific constraints (Node.js CLI, git worktrees,
TypeScript, modular architecture). Call out anything that applies differently
